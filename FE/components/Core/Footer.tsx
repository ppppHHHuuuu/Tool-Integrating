...
const Footer: React.FC = () => {
  return (
    <footer className="flex-col items-center text-white duration-300">
      <div className="grid w-full px-10 py-20 duration-300 bg-slate-950 sm:grid-cols-2 sm:px-20 md:grid-cols-4 md:space-x-4 lg:px-40 ">
        ...
        <div className="w-full">
          ...
          <div className="flex gap-4 mt-4">
            <Link className="p-2 duration-500 border hover:border-white border-slate-950 animate__animated animate__fadeInUp animate__delay-fast rounded-3xl" href="1"><BiLogoFacebook className="w-6 h-6"/></Link>
            <Link className="p-2 duration-500 border hover:border-white border-slate-950 animate__animated animate__fadeInUp animate__delay-fast rounded-3xl" href="1"><BiLogoGithub className="w-6 h-6"/></Link>
            <Link className="p-2 duration-500 border hover:border-white border-slate-950 animate__animated animate__fadeInUp animate__delay-fast rounded-3xl" href="1"><BiLogoGmail className="w-6 h-6"/></Link>
          </div>
        </div>
      </div>
      <div className="flex items-center w-full px-10 py-10 duration-300 bg-slate-950 sm:px-20 lg:px-40">
        <ul className="w-full gap-2 bg-slate-950 md:flex md:justify-between">
          <div>
            <p className="font-semibold text-start md:w-full animate__animated animate__fadeInUp animate__delay-1s">
              COPYRIGHT 2023
            </p>
          </div>
          <div>
