...
const ProPlan: React.FC = () => {
    ...
    return (
        <div className="w-full max-w-lg xl:max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 ">
            <h5 className="mb-4 text-xl font-medium text-gray-500 ">Professional plan</h5>
            <div className="flex items-baseline text-gray-900">
                <span className="text-3xl font-semibold">$</span>
                <span className="duration-500 text-5xl font-extrabold tracking-tight">{plan==="month" ? "249" : "2499"}</span>
